<ul class="sidebar-menu">
    ...
    <li><a href="{{ route('services.index') }}"><i class="fa fa-tags"></i> <span>Новости</span></a></li>
    <li><a href="{{ route('video.index') }}"><i class="fa fa-tags"></i> <span>Видео</span></a></li>
    ...
    <li><a href="{{ route('stock.index') }}"><i class="fa fa-user-plus"></i> <span>Акции</span></a></li>
    <li>
