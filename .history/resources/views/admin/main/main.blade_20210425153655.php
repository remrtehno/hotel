...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/assets/assets/font-awesome/4.5.0/css/font-awesome.min.css">

    <link rel="stylesheet" href="/assets/assets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="/assets/assets/plugins/datatables/dataTables.bootstrap.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="/assets/assets/ionicons/2.0.1/css/ionicons.min.css">
    <!-- Theme style -->
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <nav class="navbar navbar-static-top">
                ...
                <a href="/assets/#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li>
                                            ...
                                            <a href="/assets/#">
                                                <div class="pull-left">
                                                    <img src="/assets/assets/dist/img/user2-160x160.jpg"
    ...
    <!-- jQuery 2.2.3 -->
    <script src="/assets/assets/plugins/jQuery/jquery-2.2.3.min.js"></script>
