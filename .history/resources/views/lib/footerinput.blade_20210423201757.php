        ...
        <div class="bottom">
            <div class="bottom__row">
                <div class="bottom__copyright">
                    ...
                    <br>
                    <span>Предложение не является публичной офертой. Производитель оставляет за собой право вносить изменения в конструкцию без предварительного уведомления.</span>
                </div>
...
<div class="modal  js-modal" id="js-request">
    ...
    <form class="form" action="" enctype="multipart/form-data">
        ...
        <div class="form__file">
            ...
            <span>
                <svg><use xlink:href="img/sprite.svg#file"></use></svg> 
                Прикрепить файл
            </span>
        </label>
        ...
        <div class="form__checkbox">
            ...
            <label for="agree">
            <span>Нажимая кнопку «Отправить», я соглашаюсь на <a href="soglashenie-ob-obrabotke-personalnyh-dannyh.html">обработку персональных данных</a></span>
            <svg>
        ...
        <button class="form__submit FLajax" type="submit" data-fl-theme="Сообщение с сайта Виртумед"><span>Отправить сообщение</span></button>
    </form>
    <!-- END FORM -->
