                ...
                <div class="col-xl-6">
                    ...
                    <div>
                        <ul>
                            ...
                            <li>Мы постарались учесть все нюансы в оформлении и наполнении номеров "РОЯЛ ПЛАЗА", чтобы у Вас остались только положительные впечатления от пребывания.</li>
                            <li>
                                Для гостей с ограниченными возможностями здоровья мы предоставляем номера, оборудованные с учётом их повышенных потребностей. А для постояльцев, заселяющихся с домашними животными - номера, где можно комфортно разместиться с питомцем.
                            </li>
                        </ul>
                    </div>
                </div>
