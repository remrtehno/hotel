            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <a href="{{route('video.create')}}" class="btn btn-success">Добавить</a>
                    </div>
...
<video width="300"  controls="controls">
 <source src="/uploads/video/{{ $item->file }}">
                            ...
                            <td><a href="{{ route('video.edit',['id'=>$item->id]) }}" class="fa fa-pencil" style="float: left;"></a>

<form action="{{route('video.destroy',['id'=>$item->id])}}" method="post">
    @csrf
