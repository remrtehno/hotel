...
@include('admin.errors')
    ...
    <form action="{{route('about.update',['id'=>$sl->id])}}" method="post" enctype="multipart/form-data">
        @csrf
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Обновляем о нас</h3>
                </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Описание на главной странице</label>
